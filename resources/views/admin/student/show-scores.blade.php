                    ...
                    @foreach ($student->exams as $exam)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{url("dashboard/student/open-exam/{$student->id}/{$exam->id}")}}" class="btn btn-warning ">lock</a>
                            ...
                            {{--    <div class="d-flex ml-2">
                                ...
                                <button type="button" class="btn btn-sm btn-warning p-2 m-1 edit-btn"  data-id="{{$category->id}}" data-name-en="{{$category->name('en')}}"
                                    data-name-ar="{{$category->name('ar')}}"  data-toggle="modal" data-target="#edit-modal">edit</button>



                            <a href="{{url("dashboard/category/delete/{$category->id}")}}" class="btn btn-sm btn-danger p-2 m-1" >delete</a>
