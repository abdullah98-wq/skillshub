...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> edit exam questions</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="{{url("dashboard/exams/edit") }}" enctype="multipart/form-data">
                   @csrf
                   <div class="card-body">
                       <div class="row">
                           <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                  ...
                                  <select name="skill_id" id="edit-form-cat-id" class="form-control">
                                      ...
                                      <option value="{{$skill->id}}"@if ($exam->skill_id==$skill_id)selected @endif>{{$skill->name('en')}}</option>
